...
wine = read.csv2("https://archive.ics.uci.edu/ml/machine-learning-databases/wine-quality/winequality-white.csv")
attach(white_wine)
summary(white_wine)
...
hist(white_wine$quality, main = "Histogram for Quality of White Wine", xlab = "Quality", ylab = "count", col = "seagreen");
